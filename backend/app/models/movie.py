...
class MovieBase(SQLModel):
    ...
    poster_link: Optional[str] = Field(default=None, description="Link to the movie poster")
    letterboxd_slug: Optional[str] = Field(default=None, description="Letterboxd slug for the movie")
...
class MovieUpdate(SQLModel):
    title: Optional[str] = Field(default=None, description="Title of the movie")
    poster_link: Optional[str] = Field(default=None, description="Link to the movie poster")
    letterboxd_slug: Optional[str] = Field(default=None, description="Letterboxd slug for the movie")
