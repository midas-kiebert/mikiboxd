    ...
    <Flex justify="center" px={4} py={10}>
      <Box maxWidth="640px" width="100%">
        ...
        <Section title="What we collect">
          <Text>
            When you create a MiKiNO account, we store your email address, the
            username you choose, and your password (hashed — we never store it
            in plain text, and cannot read it back). If you sign in with Apple
            or Google, we store the identifier that provider gives us for your
            account instead of a password.
          </Text>
          <Text>
          ...
          <Text>
            ...
            deliver them. We do not collect your location, contacts, photos, or
            microphone/camera data — MiKiNO never asks for access to any of
            these.
          </Text>
          <Text>
            We record which screenings you mark as going to or interested in,
            your friends and friend requests, and invites you send or receive,
            since showing this to your friends (subject to your visibility
            settings) is the app&apos;s core function.
          </Text>
          <Text>
            We record basic usage events against your account — such as signing
            in, opening the app, and applying a filter — to understand which
            features are actually used. We do not use any third-party analytics
            or advertising SDK, and MiKiNO does not track you across other apps
            or websites.
          </Text>
        </Section>
        ...
        <Section title="How we use it">
          <Text>
            ...
            your data, and we do not share it with third parties for
            advertising.
          </Text>
          <Text>
            We use a small number of service providers to run the app: an email
            delivery provider to send account and notification emails, and a
            push notification service (Firebase Cloud Messaging / Apple Push
            Notification service) to deliver push notifications. These providers
            only see what is necessary to deliver that message.
          </Text>
        </Section>
        ...
        <Section title="Other users">
          <Text>
            ...
            spam, or an objectionable username; we review reports and may
            suspend or ban an account as a result.
          </Text>
        </Section>
        ...
        <Section title="Retention and deletion">
          ...
          <Text>
            ...
            Sign in with Apple authorization associated with it.
          </Text>
          <Text>
            To withdraw consent for notifications or the email digest without
            deleting your account, use the toggles in Settings, or the
            unsubscribe link in any digest email.
          </Text>
        </Section>
