/**
 * Day-selection model + helpers shared by mobile and web. Day filters are stored as
 * tokens — `relative:today|tomorrow|day_after_tomorrow`, `weekday:1..7`, or literal
 * ISO dates — and resolved to concrete ISO dates for the API. Pure (luxon only) so
 * both platforms import it; mobile re-exports it from
 * `mobile/components/filters/day-filter-utils.ts`.
 */
