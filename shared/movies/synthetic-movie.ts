 ...
 * (`backend/app/models/movie.py`). Shared rather than per-client because the
 * placeholder is a piece of wording: a film the app calls "???" and the website
 * calls "Unknown" is two products.
 */
