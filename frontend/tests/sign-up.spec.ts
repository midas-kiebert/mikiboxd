...
const fillForm = async (
  ...
  await page.getByPlaceholder("Full Name").fill(display_name)
...
test("Sign up with valid name, email, and password", async ({ page }) => {
  ...
  await page.goto("/signup")
  await fillForm(page, display_name, email, password, password)
...
test("Sign up with existing email", async ({ page }) => {
  ...
  await fillForm(page, displayName, email, password, password)
  await page.getByRole("button", { name: "Sign Up" }).click()
...
test("Sign up with mismatched passwords", async ({ page }) => {
  ...
  await fillForm(page, displayName, email, password, password2)
  await page.getByRole("button", { name: "Sign Up" }).click()
