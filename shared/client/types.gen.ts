 ...
 */
export type AnalyticsEventName = 'login' | 'app_open' | 'filter_applied' | 'preset_used' | 'invite_sent' | 'notification_clicked';
 ...
 */
export type CinemaSeatingPreset = 'unknown' | 'free' | 'number-number' | 'letter-number' | 'number-letter' | 'letter-letter';
...
export type NotificationFeedItem = {
    ...
    id: string;
    type: 'friend_showtime_match' | 'showtime_invite' | 'invite_response' | 'friend_request_received' | 'friend_request_accepted';
    created_at: string;
    seen_at: (string | null);
...
export type type = 'friend_showtime_match' | 'showtime_invite' | 'invite_response' | 'friend_request_received' | 'friend_request_accepted';
 ...
 */
export type ShowtimeReportReason = 'incorrect_movie' | 'incorrect_time' | 'does_not_exist' | 'duplicate' | 'wrong_subtitles' | 'other';
...
export type ShowtimesGetSentPingsForShowtimeResponse = (Array<SentShowtimePingPublic>);

export type ShowtimesGetShowtimeVisibilityBatchData = {
    showtimeIds?: Array<(number)>;
};

export type ShowtimesGetShowtimeVisibilityBatchResponse = (Array<ShowtimeVisibilityPublic>);
