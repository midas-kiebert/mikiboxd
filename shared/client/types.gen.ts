...
export type AndroidBetaRequest = {
...
export type UtilsRequestAndroidBetaData = {
  requestBody: AndroidBetaRequest
}

export type UtilsRequestAndroidBetaResponse = Message
